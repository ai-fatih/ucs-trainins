...
const products: Product[] = [
  {
    ...
    group: 'desktop',
    scenarios: [
      { title: 'Создание и оплата заказа', desc: 'Открытие смены, добавление позиций, приём оплаты наличными и картой', href: '/docs/rkeeper/rk7/create-order' },
      { title: 'Управление сменами', desc: 'Открытие и закрытие кассовой смены, сверка отчётов, X- и Z-отчёты', href: '/docs/rkeeper/rk7/shift-management' },
      { title: 'Скидки и возвраты', desc: 'Применение скидок на позицию или чек, оформление возврата по закрытому чеку', href: '/docs/rkeeper/rk7/discounts-returns' },
    ],
  },
  {
    id: 'storehouse',
    ...
    group: 'desktop',
    scenarios: [
      { title: 'Списание товаров', desc: 'Создание и проведение документа списания, указание причин и проверка остатков', href: '/docs/rkeeper/storehouse/write-off' },
      { title: 'Инвентаризация', desc: 'Проведение инвентаризации: опись, ввод фактических остатков, обработка расхождений', href: '/docs/rkeeper/storehouse/inventory' },
      { title: 'Оприходование товаров', desc: 'Оформление поступления товаров на склад, добавление номенклатуры и цен', href: '/docs/rkeeper/storehouse/arrival' },
    ],
  },
  {
    id: 'delivery',
    ...
    group: 'cloud',
    scenarios: [
      { title: 'Создание заказа доставки', desc: 'Выбор гостя, сбор заказа из меню, назначение курьера и подтверждение', href: '/docs/rkeeper/delivery/create-order' },
      { title: 'CourierApp — приложение курьера', desc: 'Выход на смену, приём и доставка заказа, завершение и отчёт', href: '/docs/rkeeper/delivery/courier-app' },
      { title: 'Приём заказа в колл-центре', desc: 'Работа со списком заказов, карточка заказа, назначение курьера', href: '/docs/rkeeper/delivery/call-center' },
    ],
  },
  {
    id: 'event',
...
export default function InstructionsPage() {
  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#111827] mb-2">Документация</h1>
