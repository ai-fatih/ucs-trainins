    ...
    <div className="max-w-[800px] mx-auto px-4 py-12">
      ...
      <div className="mt-8 pt-6 border-t border-[#e5e7eb]">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/docs/rkeeper/delivery/create-order" className="text-sm text-[#1a56db] hover:underline no-underline">
            &larr; Создание заказа доставки
          </Link>
          <Link href="/docs/rkeeper/delivery" className="text-sm text-[#1a56db] hover:underline no-underline">
