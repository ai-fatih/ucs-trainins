...
const sections = [
  {
    ...
    items: [
      { href: '/docs/rkeeper/delivery/create-order', label: 'Создание заказа доставки', desc: 'От выбора гостя до передачи на кухню и курьеру' },
      { href: '/docs/rkeeper/delivery/call-center', label: 'Приём заказа в колл-центре', desc: 'Работа со списком заказов, карточка заказа, назначение курьера' },
    ],
  },
  {
    title: 'Мобильные приложения',
    items: [
      { href: '/docs/rkeeper/delivery/courier-app', label: 'CourierApp — приложение курьера', desc: 'Выход на смену, приём и доставка заказа, завершение' },
    ],
  },
];
