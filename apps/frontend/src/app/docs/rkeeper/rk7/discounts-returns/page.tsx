    ...
    <div className="max-w-[800px] mx-auto px-4 py-12">
      ...
      <div className="mt-8 pt-6 border-t border-[#e5e7eb]">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/docs/rkeeper/rk7/shift-management" className="text-sm text-[#1a56db] hover:underline no-underline">&larr; Управление сменами</Link>
          <Link href="/docs/rkeeper/rk7" className="text-sm text-[#1a56db] hover:underline no-underline">Все сценарии r_keeper 7 &rarr;</Link>
        </div>
      </div>
    </div>
  );
