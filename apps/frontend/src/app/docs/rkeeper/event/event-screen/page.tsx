    ...
    <div className="max-w-[800px] mx-auto px-4 py-12">
      <div className="mb-10">
        <div className="flex items-center gap-2 text-sm text-[#6b7280] mb-3">
          ...
          <span>/</span>
          <span className="text-[#111827]">Экран событий</span>
        </div>
      ...
      <div className="mt-8 pt-6 border-t border-[#e5e7eb]">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/docs/rkeeper/event/notifications" className="text-sm text-[#1a56db] hover:underline no-underline">
            &larr; Настройка оповещений
          </Link>
          <Link href="/docs/rkeeper/event/devices" className="text-sm text-[#1a56db] hover:underline no-underline">
            Подключение устройств &rarr;
          </Link>
        </div>
      </div>
    </div>
