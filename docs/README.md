...
| `Быстрые_ответы/` | FAQ-материалы по продуктам (контент раздела «Документация») |
...
5. **Варианты дизайна на согласование** → `design-vars/`, добавлять карточку в `design-vars/index.html`.
